...
/**
 * @author cheny
 * @date 2023年02月25日 16:18
 * @des 读取指定的mp4文件，推送到SRS服务器
 */
@Slf4j
public class PushMp4  {

    /**
     * 1.本地MP4文件的完整路径(两分零五秒的视频)
     */
    private static final String MP4_FILE_PATH = "E:\\BaiduNetdiskDownload\\sample-mp4-file.mp4";

    /**
     * 2.SRS的推流地址
     */
    private static final String SRS_PUSH_ADDRESS = "rtmp://192.168.2.137:11935/live/livestream";
    ...
    private static void grabAndPush(String sourceFilePath, String PUSH_ADDRESS) throws Exception {
        ...
        // 3.初始化帧抓取器，例如数据结构（时间戳、编码器上下文、帧对象等），
